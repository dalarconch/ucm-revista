...
<body>
	<div class="wrapper">
	    <div class="sidebar" data-active-color="rose" data-background-color="black" data-image="{{ asset('material/assets/img/sidebar-1.jpg') }}">
	    <!--
	    ...
	    -->
		    ...
		    <div class="logo">
		        <a href="http://portal.ucm.cl/" class="simple-text">
		            REVISTA UCM
		        </a>
		    </div>
		    ...
		    <div class="sidebar-wrapper">
		        <div class="user">
		            <div class="photo">
		                <img src="{{ asset('material/assets/img/faces/avatar1.jpg') }}" />
		            </div>
		            <div class="info">
	...
	<!-- Select Plugin -->
	<script src="{{ asset('material/assets/js/jquery.dropdown.js') }}"></script>
